 ...
 * ```
 */
 // TODO this is a temporary solution, since currently no ethernet ist used.
 // TODO solve this problem later
 // https://github.com/espressif/esp-idf/blob/v4.2/examples/ethernet/basic/main/ethernet_example_main.c
#include <esp_eth.h>
